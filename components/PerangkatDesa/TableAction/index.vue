  ...
  >
    ...
    <div class="action__dropdown">
      <ul class="action__dropdown-list">
        ...
        <li>
          <button v-if="status === userStatus.waiting" class="action__dropdown-item" @click="$emit('verify')">
            Verifikasi Akun
          </button>
          <button v-if="status === userStatus.inactive" class="action__dropdown-item" @click="$emit('activate')">
            Aktif
          </button>
          <button v-if="status === userStatus.active" class="action__dropdown-item" @click="$emit('deactivate')">
            Non Aktif
          </button>
        </li>
        <li>
